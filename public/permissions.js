...
async function loadPermissions() {
  ...
  try {
    ...
    rules.forEach((rule) => {
      ...
      const edit = Object.assign(document.createElement("button"), { className: "icon-btn", textContent: "Edit", title: "Edit permissions" });
      edit.addEventListener("click", () => openPermissionEditor(rule.path, rule.permissions));
      const clear = Object.assign(document.createElement("button"), { className: "icon-btn", textContent: "Reset", title: "Restore inherited permissions" });
...
function addPermissionButton(container, filepath, permissions) {
  ...
  const btn = Object.assign(document.createElement("button"), { className: "icon-btn", textContent: "Edit", title: "Customize user permissions" });
...
layoutTweaksScript.src = "layout-tweaks.js?v=20260716-mcplink1";
